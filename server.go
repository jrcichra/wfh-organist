...
func sendNotes(midiPort int, notesChan chan interface{}) {
	...
	for {
		...
		case NoteOn:
			...
			midiTuxPrint(color.FgHiGreen, m, ms)
		case NoteOff:
			ms := handleMs(m.Time)
